...
if __name__ == "__main__":
    ...
    dfs = []
    vals_weight = np.linspace(0.1, 0.9, 9)
    for weight in vals_weight:
        results = {}
        for abbr, data in ds["BORISOV_2009"].items():
            alg.params.weight = weight
            alg.data = data            
    ...
    df_merged.to_csv("aps_borisov_2009_varying_weight.tsv", sep='\t')
